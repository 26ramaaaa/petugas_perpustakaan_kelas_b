  ...
  Future<void> getData() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        final ResponsePinjam responsePeminjam = ResponsePinjam.fromJson(response.data);
        if (responsePeminjam.data!.isEmpty) {
          change(null, status: RxStatus.empty());
        } else {
          change(responsePeminjam.data, status: RxStatus.success());
        }
      } else {
